...
export function TokenSelector({
  ...
  return (
    <div className="modal-overlay bg-black/60 flex items-center justify-center p-4 z-50 backdrop-blur-sm" onClick={onClose}>
      <div className="bg-white dark:bg-slate-800 rounded-2xl border border-slate-200 dark:border-slate-700 shadow-card-lg max-w-md w-full max-h-[80vh] flex flex-col" onClick={(e) => e.stopPropagation()}>
        {/* Header */}
        <div className="p-6 border-b border-slate-200 dark:border-slate-700">
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2.5 text-sm border border-slate-200 dark:border-slate-600 rounded-xl focus:outline-none focus:ring-2 focus:ring-brand-orange focus:border-transparent bg-white dark:bg-slate-700 text-slate-900 dark:text-slate-100 placeholder-slate-400"
              autoFocus
            />
          </div>
        </div>
            ...
            <div className="space-y-1">
              {filteredTokens.map((token, index) => (
                <motion.button
                  ...
                  className="w-full flex items-center justify-between p-4 rounded-xl transition-all hover:bg-slate-50 dark:hover:bg-slate-700/50 border border-transparent hover:border-brand-orange/30 dark:hover:border-brand-orange/40 group cursor-pointer hover:shadow-md active:scale-[0.98]"
                >
                  <div className="flex items-center gap-4 flex-1 min-w-0">
                    ...
                    <div className="flex-1 min-w-0 text-left">
                      <p className="font-bold text-slate-900 dark:text-slate-100">{token.symbol}</p>
